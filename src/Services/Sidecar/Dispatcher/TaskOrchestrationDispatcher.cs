...
class TaskOrchestrationDispatcher(
    ...
    ITaskExecutor taskExecutor) : WorkItemDispatcher<TaskOrchestrationWorkItem>(log, trafficSignal)
{
    ...
    public override Task<TaskOrchestrationWorkItem?> FetchWorkItemAsync(
        TimeSpan timeout,
        ...
        out bool continueAsNew)
    {
        ...
        List<TaskMessage>? newActivityMessages = null;
        List<TaskMessage>? newTimerMessages = null;
        List<TaskMessage>? newOrchestratorMessages = null;
        ...
        activityMessages = (IList<TaskMessage>?)newActivityMessages ?? Array.Empty<TaskMessage>();
        timerMessages = (IList<TaskMessage>?)newTimerMessages ?? Array.Empty<TaskMessage>();
        orchestratorMessages = (IList<TaskMessage>?)newOrchestratorMessages ?? Array.Empty<TaskMessage>();
