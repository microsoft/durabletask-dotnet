...
/// <summary>
/// A delegate that invokes the next orchestration middleware in the pipeline.
/// </summary>
...
public delegate Task TaskOrchestrationMiddlewareDelegate(TaskOrchestrationMiddlewareContext context);
