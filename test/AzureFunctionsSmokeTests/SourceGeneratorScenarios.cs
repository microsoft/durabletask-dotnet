...
{
    const string DefaultName = "SourceGen";
    ...
    public override async Task<GeneratorResult> RunAsync(TaskOrchestrationContext context, GeneratorRequest? input)
    {
        ...
        EntityId counterId = new EntityId(nameof(GeneratorCounter), context.InstanceId);
        await context.SignalEntityAsync(counterId, "Add", length);
        int total = await context.CallEntityAsync<int>(counterId, "GetCount");
...
public static class GeneratorFunctions
{
        ...
        FunctionContext executionContext)
    {
        ...
        string instanceId = await client.ScheduleNewGeneratedOrchestrationInstanceAsync(
            request ?? new GeneratorRequest(DefaultName));
