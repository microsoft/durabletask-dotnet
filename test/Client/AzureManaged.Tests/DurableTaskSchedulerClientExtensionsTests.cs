...
public class DurableTaskSchedulerClientExtensionsTests
{
    ...
    public void UseDurableTaskScheduler_WithNullParameters_ShouldThrowOptionsValidationException(string? endpoint, string? taskHub)
    {
        ...
        // Assert
        Func<DurableTaskSchedulerClientOptions> action = () => provider.GetRequiredService<IOptions<DurableTaskSchedulerClientOptions>>().Value;
    ...
    [InlineData("")]
    [InlineData(null)]
    public void UseDurableTaskScheduler_WithNullOrEmptyConnectionString_ShouldThrowArgumentException(
