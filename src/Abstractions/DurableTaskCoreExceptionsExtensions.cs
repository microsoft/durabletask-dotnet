...
{
    /// <summary>
    /// Converts <paramref name="taskFailedException"/> to a <see cref="Dapr.DurableTask.TaskFailureDetails"/> instance.
    ...
    /// <returns>
    /// A <see cref="Dapr.DurableTask.TaskFailureDetails"/> instance if <paramref name="taskFailedException"/> contains
    ...
    /// <summary>
    /// Converts <paramref name="subOrchestrationFailedException"/> to a <see cref="Dapr.DurableTask.TaskFailureDetails"/> instance.
    ...
    /// <returns>
    /// A <see cref="Dapr.DurableTask.TaskFailureDetails"/> instance if <paramref name="subOrchestrationFailedException"/> contains
    /// FailureDetails; otherwise, null is returned.
    /// </returns>
    ...
    /// <summary>
    /// Converts <paramref name="failureDetails"/> to a <see cref="Dapr.DurableTask.TaskFailureDetails"/> instance.
    /// </summary>
    /// <param name="failureDetails"><see cref="global::DurableTask.Core.FailureDetails"/> instance.</param>
    /// <returns>
    /// A <see cref="Dapr.DurableTask.TaskFailureDetails"/> instance if <paramref name="failureDetails"/> is not null; otherwise, null.
    /// </returns>
