...
public class ProfileController : ControllerBase
{
    ...
    // add endpoint to get instance by id
    [HttpGet("{instanceId}")]
    public async Task<ActionResult<string>> GetInstance(string instanceId)
    {
        return this.Ok(await this.durableTaskClient.GetInstanceAsync(instanceId, true));
    }
}