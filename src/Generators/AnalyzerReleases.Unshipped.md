...
DURABLE3005 | DurableTask.Design | Error | **DurableTaskSourceGenerator**: Reports when a [DurableTaskVersion] attribute is constructed with a whitespace-only argument. Provide a non-empty version or omit the attribute.
