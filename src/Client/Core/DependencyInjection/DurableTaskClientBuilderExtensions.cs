...
public static class DurableTaskBuilderExtensions
{
    ...
    /// Registers <see cref="LargePayloadStorageOptions"/>, <see cref="IPayloadStore"/> and wraps the
    /// configured <see cref="DataConverter"/> in an <see cref="LargePayloadDataConverter"/> for this client name.
    /// </summary>
    /// <param name="builder">The <see cref="IDurableTaskClientBuilder"/> to configure.</param>
    /// <param name="configure">The action to configure the <see cref="LargePayloadStorageOptions"/>.</param>
    /// <returns>The <see cref="IDurableTaskClientBuilder"/>.</returns>
