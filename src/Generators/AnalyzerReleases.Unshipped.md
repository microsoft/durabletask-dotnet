...
DURABLE3005 | DurableTask.Design | Error | **DurableTaskSourceGenerator**: Reports when the [DurableTask] Version property is set to a whitespace-only value. Provide a non-empty version or omit the Version argument.
